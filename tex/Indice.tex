...
\section*{Nota}
Il presente documento riporta la struttura che intendo seguire per la
stesura della tesi.
\vspace{1cm}
...
\section{Problemi QUBO}
Definire formalmente un problema QUBO (Quadratic Unconstrained Binary Optimization),
la sua forma matriciale $x^TQx$ e perché è centrale nel quantum annealing.
...
\section{Algoritmo}
Descrivere l'idea generale e lo pseudocodice di QALS: ciclo di annealing classico
esterno, meccanismo tabù integrato nel profilo energetico, notazione e parametri
principali.

\section{Implementazione}
Mostrare l' iplementazione Python di QALS usata.
...
\(\alpha\) sull'energia e sulla probabilità di accettazione nel simulated
annealing, con il compromesso tra esplorazione e precisione.

\section{Parametro Swap(k, TIMES)}
Introdurre la distinzione tra il parametro \(k\) (numero di chiamate
...
quelle ottenute da Gurobi sulle istanze di test, evidenziando corrispondenze
e discrepanze.
