...
\section{Approcci ibridi}
\label{sec:approcci-ibridi}
% Presentare il paradigma ibrido quantistico-classico, le motivazioni legate all'era NISQ
% e una panoramica delle soluzioni esistenti in letteratura.

\section{Simulated Annealing}
\label{sec:simulated-annealing}
% Richiamare i concetti di simulated annealing classico, le catene di Markov disomogenee
% e la probabilità di accettazione, necessari per comprendere la dimostrazione di convergenza di QALS.
